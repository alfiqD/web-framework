...
export default function CompanyProfile() {
    ...
    <div className="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            {/* --- FINAL CTA SECTION (Menggantikan Newsletter) --- */}
<section className="py-16 lg:py-20 bg-gradient-to-r from-[#B01030] to-red-800 px-4 sm:px-6 lg:px-10 mb-8 rounded-3xl mx-4 max-w-[1400px] xl:mx-auto">
    <div className="flex flex-col items-center justify-center text-center max-w-2xl mx-auto">
        <h2 className="text-3xl lg:text-5xl font-black text-white mb-4">Mulai Perawatan Terbaikmu Hari Ini</h2>
        <p className="text-white/80 mb-8 font-medium">Bergabunglah dengan ribuan wanita lainnya dan jadilah member untuk mendapatkan manfaat maksimal.</p>
        <button onClick={() => navigate('/login')} className="bg-white text-[#B01030] px-8 py-4 rounded-full font-black text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300">
