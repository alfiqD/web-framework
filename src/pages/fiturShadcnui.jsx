...
export default function FiturShadcnui() {
  return (
    <div
      ...
      className="flex flex-col gap-6 font-nunito bg-[#F5F6FA] min-h-screen pb-10"
    >
      {/* --- PAGE HEADER & BREADCRUMB --- */}
      <PageHeader
        title="Fitur Shadcn UI"
        breadcrumb={["Dashboard", "Fitur Shadcn UI"]}
      />
      ...
      <div className="px-8 mt-2">
        ...
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 min-h-[600px] flex flex-col gap-8">
          <div>
            <h2 className="text-xl font-extrabold text-[#202224] mb-1">
              Koleksi Komponen Shadcn UI
            </h2>
            <p className="text-sm text-gray-400 font-medium">
              Daftar komponen interaktif yang diintegrasikan ke dalam sistem
              dasbor.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border border-gray-100 rounded-2xl p-6 bg-[#F5F6FA]/50 flex flex-col justify-between min-h-[220px]">
              <div>
                <span className="text-xs font-extrabold text-[#B01030] uppercase tracking-wider">
                  Komponen 01
                </span>
                <h3 className="text-lg font-bold text-[#202224] mt-0.5">
                  Input OTP
                </h3>
                <p className="text-xs text-gray-500 font-medium mt-1 mb-6 leading-relaxed">
                  Digunakan untuk memasukkan kode verifikasi/keamanan (One-Time
                  Password) secara aman, seperti verifikasi login dokter atau
                  akses data pasien kritis.
                </p>
              </div>
            ...
            <div className="border border-gray-100 rounded-2xl p-6 bg-[#F5F6FA]/50 flex flex-col justify-between min-h-[220px]">
              <div>
                ...
                <p className="text-xs text-gray-500 font-medium mt-1 mb-6 leading-relaxed">
                  Indikator visual yang menandakan sistem sedang memproses data,
                  seperti saat memuat rekam medis pasien atau mengunduh laporan
                  keuangan.
                </p>
              </div>
            ...
            <div className="border border-gray-100 rounded-2xl p-6 bg-[#F5F6FA]/50 flex flex-col justify-between md:col-span-2 min-h-[260px]">
              <div>
                ...
                <p className="text-xs text-gray-500 font-medium mt-1 mb-6 leading-relaxed">
                  Menampilkan sekumpulan konten atau informasi secara bergantian
                  (slide). Berguna untuk menampilkan *banner* pengumuman
                  internal rumah sakit atau statistik performa berkala.
                </p>
              </div>
